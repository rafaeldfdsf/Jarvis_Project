...
import '../widgets/activity_history_panel.dart';

class ActivityHistoryScreen extends StatelessWidget {
  const ActivityHistoryScreen({super.key, this.embedded = false});
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Aqui podes ver, de forma simples, o que o assistente fez: pesquisas, sites, aplicacoes e outras acoes.',
                      style: TextStyle(
              ...
              const Expanded(
                child: ActivityHistoryPanel(title: 'Historico de atividade'),
              ),
            ],
          ),
        ),
