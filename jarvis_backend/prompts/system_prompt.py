...
BASE_SYSTEM_PROMPT = (
    ...
    "Exemplos importantes: para por uma musica no YouTube usa control_computer com action youtube_play e query.\n"
    "Para apenas pesquisar no YouTube usa control_computer com action youtube_search e query.\n"
